---
name: git-worktree
description: Use git worktree to isolate feature work in a separate directory, keeping the main checkout clean and avoiding branch-switching accidents that corrupt open PRs. Use when the user wants to start a feature branch, says "create a worktree", "use worktrees", "branch in isolation", or mentions branch-switching accidents in the primary checkout.
---
