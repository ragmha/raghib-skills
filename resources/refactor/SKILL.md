---
name: refactor
description: Surgical code refactoring to improve maintainability without changing behavior. Covers extracting functions, renaming variables, breaking down god functions, improving type safety, eliminating code smells, and applying design patterns. Use for gradual improvements when a full rewrite would be too drastic, or when the user says "refactor this", "clean up this code", "improve this", "extract function", or mentions code smells / god functions / type safety.
license: MIT
---
